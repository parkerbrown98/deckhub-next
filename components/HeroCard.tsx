...
const HeroCard = ({ post }: Props) => {
    ...
    return (
        <article className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8">
            <LinkWrapper href={url} className={`relative min-h-[300px] md:min-h-[350px] lg:min-h-[400px] overflow-hidden`}>
            ...
            <div>
                <div>
                    ...
                    <LinkWrapper href={url}>
                        <h4 className="text-3xl font-semibold leading-tight">{ post.title }</h4>
                    </LinkWrapper>
